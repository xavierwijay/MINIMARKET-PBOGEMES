 ...
 * @author LENOVO
 */
public class MenuRotiAdmin extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(MenuRotiAdmin.class.getName());

    /**
     * Creates new form NewJFrame
     */
    public MenuRotiAdmin() {
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        EditMenuKueUlangTahunAdmin ema = new EditMenuAdmin();
        ema.setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new MenuRotiAdmin().setVisible(true));
    }
